...
export interface Pillar {
  ...
  path: string;
  /**
   * Open to everyone, signed in or not — the one launched pillar. Every other
   * pillar stays locked until the viewer signs in.
   */
...
export const PILLARS: Pillar[] = [
  ...
  { letter: "M", label: "Mission",        color: "#d69c00", path: "/mission",        alwaysAvailable: true, icon: <span className="mi-glyph mission-glyph" style={{ lineHeight: 1, fontWeight: 500 }}>&#934;<span className="mission-staff">§</span></span> },
