      ...
      <Box sx={{ position: "relative", overflow: "hidden", color: "white", background: "#10132f" }}>
        ...
        <Container maxWidth="lg" sx={{ position: "relative", py: { xs: 3, md: 4 } }}>
          ...
          <Box sx={{ maxWidth: 590, pt: { xs: 8, md: 11 }, pb: { xs: 8, md: 9 } }}>
            ...
            <Typography sx={{ maxWidth: 510, fontSize: { xs: 15, md: 18 }, lineHeight: 1.55 }}>{lang === "es" ? "Currículo psicoeducativo de apoyo y procesamiento para personas afectadas directa e indirectamente por el terremoto de Venezuela." : "A psychoeducational curriculum offering support and processing for people directly and indirectly affected by the earthquake in Venezuela."}</Typography>
