      ...
      <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", md: "275px minmax(0,1fr)" }, gap: 2, alignItems: "stretch" }}>
        ...
        <Box component="main" sx={{ display: "grid", gap: 2, minWidth: 0 }}>
          <Box sx={{ bgcolor: "rgba(255,255,255,.76)", border: "1px solid rgba(69,45,143,.15)", borderRadius: 3, p: { xs: 2.5, md: 4 } }}>
            <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}><FavoriteBorderRoundedIcon sx={{ color: PURPLE, fontSize: 42 }} /><Typography component="h1" sx={{ fontFamily: SERIF, fontSize: { xs: 32, md: 40 } }}>{copy(lang, "Psychoeducational closing", "Cierre psicoeducativo")}</Typography></Box>
            <Typography sx={{ mt: 2.5, fontSize: { xs: 15, md: 17 }, lineHeight: 1.75 }}>{closing}</Typography>
          </Box>

          <Box sx={{ bgcolor: "rgba(255,255,255,.76)", border: "1px solid rgba(69,45,143,.15)", borderRadius: 3, p: { xs: 2.5, md: 4 } }}>
            <Typography sx={{ fontFamily: SERIF, fontSize: { xs: 28, md: 35 }, mb: 2.5 }}>{copy(lang, "Feedback and closing on a positive note", "Feedback y cierre en una nota positiva")}</Typography>
