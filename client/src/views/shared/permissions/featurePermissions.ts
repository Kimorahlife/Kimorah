...
export type Feature = "users" | "roles";
 ...
 * call sites.
 */
export function canDoOn(userPermissions: string[], feature: Feature, action: Action): boolean {
 ...
 */
export function hasUiAccess(userPermissions: string[], feature: Feature): boolean {
  return canDoOn(userPermissions, feature, "add");
}
 ...
 */
export function hasFullUiAccess(userPermissions: string[], feature: Feature): boolean {
  return (
 ...
 */
export function isViewOnly(userPermissions: string[], feature: Feature): boolean {
